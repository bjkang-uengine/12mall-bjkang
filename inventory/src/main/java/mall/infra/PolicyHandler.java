...
public class PolicyHandler {
    ...
    @StreamListener(
        ...
        condition = "headers['type']=='DeliveyCompleted'"
    )
    public void wheneverDeliveyCompleted_DecreaseStock(
        @Payload DeliveyCompleted deliveyCompleted
    ) {
        DeliveyCompleted event = deliveyCompleted;
        System.out.println(
            "\n\n##### listener DecreaseStock : " + deliveyCompleted + "\n\n"
        );
